				...
				<div class="form-group row">
					<div class="col-md-8 ">
						...
						@if(@$user->image['thumb'])
							<div class="col-md-12 ">
								<div class="usr-img">
									<a href="{{ $user->image['thumb'] }}" data-fancybox  >
						...
						<div class="col-md-12 ">
							...
							@if(isset($user->images))
								@foreach($user->images as $user_image)
									...
									<div class="usr-img">
										<a href="{{ $user_image->name['org'] }}" data-fancybox >
		...
		$('.add-img-div-btn').click(function(){
			...
			if(avl_img_count < max_img_count){
				var html = `<div class="form-group row ">
						<div class="col-xs-8">
							<input type="file" accept="image/*" name="multi_images[]" class="dropify form-control-file" id="picture" aria-describedby="fileHelp" multiple="">
						</div>
					</div>`;
