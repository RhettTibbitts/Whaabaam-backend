    ...
    <div class="row">
        <div class="col-md-4 offset-md-4 px-3">
            <div class="box b-a-0">
                ...
                <form class="form-material mb-1" role="form" method="POST" action="{{ url('admin/forgot-password') }}" >
                    
                    <div class="px-2 form-group mb-0">
                        <p class="text-center" >Enter your email address. You will receive an email with a link to reset your password. </p>
                    </div>
