            ...
            <tbody>
                ...
                <tr>
                    <td style="padding-top: 30px;">
                        <img src="{{ asset('public/images/system/sucess.png') }}" width="120" alt="" />
                    </td>
                </tr>
                <tr>
                    <td style="padding-top: 0;">
                        <h1 style="line-height: 1; color: #333; font-weight: 400; font-size: 35px;">Registered <span style="font-weight: 700;">Successfully</span></h1>
                    </td>
                </tr>
                <tr>
                    <td>
