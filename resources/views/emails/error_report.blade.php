    ...
    <head>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 750px; border-radius: 5px 5px 0 0px; overflow: hidden; margin: 30px auto; box-shadow: 0 0 10px 5px rgba(0,0,0,0.05);">
            <tbody>
                ...
                <tr>
                    <td>
                        <p style="color: #000; padding-left: 15px; padding-top: 35px; font-size: 24px; font-weight: 700;">You have received a new error report. Error details are given below:</p>
                    </td>
                </tr>
                <tr>
                    <td>
